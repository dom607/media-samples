...
//			mOutputPath = getCaptureFile(Environment.DIRECTORY_MOVIES, ext).toString();
    ...
    public void prepare(PuffRecorder puffRecorder) throws IOException {
        if (mVideoEncoder != null) {
            mVideoEncoder.prepare();
            puffRecorder.setVideoSurface( ((MediaVideoEncoder) mVideoEncoder).getSurface());
        }
...
//		final File dir = new File("storage/self/primary/test", DIR_NAME);
